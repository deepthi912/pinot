...
public class ExpressionTransformerTest {
  ...
  public void testCyclicTransformFunctionSortOrder() {
    ...
    List<TransformConfig> transformConfigs = Arrays.asList(new TransformConfig("a", "plus(b,10)", null, null),
        new TransformConfig("b", "plus(c,10)", null, null), new TransformConfig("c", "plus(a,10)", null, null));
    IngestionConfig ingestionConfig = new IngestionConfig();
    ingestionConfig.setTransformConfigs(transformConfigs);
    TableConfig tableConfig =
  ...
  public void testTransformFunctionWithWrongInput() {
    ...
    List<TransformConfig> transformConfigs =
        Collections.singletonList(new TransformConfig("y", "plus(x, 10)", null, null));
    IngestionConfig ingestionConfig = new IngestionConfig();
    ingestionConfig.setTransformConfigs(transformConfigs);
    TableConfig tableConfig =
